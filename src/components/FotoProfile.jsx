...
<div className="profile">
    ...
    <ul className="social-icons">
        <li>
            <a href="http://instagram.com/gustavobardavid" title="Instagram">
    ...
    <div className="profile-name">
        <h2>Gustavo Bardavid</h2>
        <div className="profile-bio">
            Im JavaScript full-stack engineer, 
...
<h1>A Software Engineer, Future Professor and Researcher</h1>
            <h2>I'm a student and living in Brazil</h2>
</div>
        </>
    );
}
